      ...
      <div class="column is-7">
        <div class="box has-text-centered">
          ...
          <a href="https://forms.gle/YourGoogleFormLink" class="button is-primary " target="_blank" rel="noopener noreferrer">
            ...
            <span>Complete Our Contact Form</span>
          </a>
          
          <p class="has-text-grey has-text-centered mt-3 is-size-7">
        ...
        <div class="box">
          ...
          <div class="content">
            ...
            <p><strong>Email:</strong><br>
             theflyingeagleind@gmail.com</p>
            <p class="mb-3">
              <a href="mailto:theflyingeagleind@gmail.com" class="button is-primary">
                <span class="icon">
          ...
          <div class="buttons">
            ...
            <a class="button is-danger" href="https://www.instagram.com/theflyingeagleind?igsh=MXhnOXNramx2bmg5cQ==" target="_blank" rel="noopener noreferrer">
              <span class="icon">
